...
class VentanaPrincipal(QMainWindow):
    ...
    def recibir_info(self, n, r, f, e, c):
        info = self.__mi_coordinador.agregarMedicamento(n, r, f, e, c)
        msm = QMessageBox.information(self, 'Informacion', info, QMessageBox.Ok)
        
    # Metodo aumentar stock
    def aumentar(self, r, c):
        a = self.__mi_coordinador.aumentarStock(r, c)
        print(a)
        msm = QMessageBox.information(self, 'Informacion', 'Aumentado con exito', QMessageBox.Ok)
        
    # Metodo disminuir stock
    def disminuir(self, r,c):
        d = self.__mi_coordinador.disminuirStock(r, c)
        print(d)
        msm = QMessageBox.information(self, 'Informacion', 'Disminuido con exito', QMessageBox.Ok)
...
class VentanaCantidad(QDialog):
    ...
    def opcion_aceptar(self):
        ...
        self.__ventana_padre.cantidad(resultado)
